...
public interface ISearchAppByTypeService {
	...
	public class SearchAppByTypeParam {
		...
		String smallTypeId;// 子分类id
		String orderType;// 根据最热或最新排序 0:最热 1:最新
		int pageSize;// 一页大小
		int currentPage;// 当前页面
		
		public SearchAppByTypeParam(String smallTypeId, String orderType, int pageSize, int currentPage) {
